...
cdur_file <- paste(base_path, "cdur.caenorhabditis_elegans_pc_transcripts.tc.csv", sep = "")
...
out_file <- paste(base_path, "cdur_plot_celegans_refseq_transcripts_tc.tiff", sep="")
ggsave(out_file, plot = cdur_plot, dpi = 600, width = 134, height = 134, device='tiff', units = "mm")

out_file <- paste(base_path, "cdur_plot_celegans_refseq_transcripts_tc.png", sep="")
ggsave(out_file, plot = cdur_plot, dpi = 1200, width = 85, height = 85, units = "mm")

out_file <- paste(base_path, "cdur_plot_celegans_refseq_transcripts_small_tc.png", sep="")
