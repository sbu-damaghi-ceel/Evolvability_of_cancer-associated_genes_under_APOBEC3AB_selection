...
base_path <- "C:/Users/CEEL-PC-005/Desktop/Joon/Final_scripts/Song2023_additional_works_1/12_additional_work_3/"
cdur_file <- paste(base_path, "cdur.saccharomyces_cerevisiae_pc_transcripts.tc.csv", sep = "")
...
out_file <- paste(base_path, "cdur_plot_palecto_refseq_transcripts_tc.tiff", sep="")
ggsave(out_file, plot = cdur_plot, dpi = 600, width = 134, height = 134, device='tiff', units = "mm")

out_file <- paste(base_path, "cdur_plot_palecto_refseq_transcripts_tc.png", sep="")
ggsave(out_file, plot = cdur_plot, dpi = 1200, width = 85, height = 85, units = "mm")

out_file <- paste(base_path, "cdur_plot_palecto_refseq_transcripts_small_tc.png", sep="")
